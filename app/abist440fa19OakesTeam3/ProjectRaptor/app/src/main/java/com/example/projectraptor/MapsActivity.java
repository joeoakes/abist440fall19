...
import com.example.projectraptor.Maps.gps;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    // Location Manager to get location lat, lng

    private TextView latitude;
    private TextView longitude;

    // Mapbox access token
    private String accessToken = "pk.eyJ1Ijoic2hwZG9uYXMiLCJhIjoiY2syajRyd3VuMW51bDNocTh0MXp4aW0ydSJ9.tjUxPynjTLLyaRSQQq6aNw";
